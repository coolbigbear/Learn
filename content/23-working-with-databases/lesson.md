# Lesson 22: Working with Databases
...
Think about the Task Manager API you built in Lesson 21. It worked, but it had a big problem: **every time you restarted the server, all your tasks disappeared!**
...
Let's bring everything together by converting the Lesson 21 Task Manager to use a real SQLite database.
...
| Before (Lesson 21) | After (Lesson 22) |
|--------------------|--------------------|
