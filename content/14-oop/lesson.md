...
Now you know how to organize code with classes. Next, we'll look at **modules and packages** (Lesson 15) — how to split your Python code across multiple files and use the vast Python ecosystem.